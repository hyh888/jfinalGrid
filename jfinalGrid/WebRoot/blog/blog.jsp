...
<body>
	<div class="manage_container">
		<div class="manage_head">
			...
			<div id="nav">
				<ul>
					<li><a href="/jfinalGrid"><b>首页</b></a></li>
					<li><a href="/jfinalGrid/blog"><b>Blog管理</b></a></li>
				</ul>
			</div>
		</div>
		<div class="main">
<h1>Blog管理&nbsp;&nbsp;
<a href="/jfinalGrid/blog/add">创建Blog</a>
</h1>
<div class="table_box">
	<table class="list">
		<tbody>
			...
			<tr>
				...
				<td style="text-align:left;">
					&nbsp;&nbsp;<a href="/jfinalGrid/blog/delete/${blog.id}">删除</a>
					&nbsp;&nbsp;<a href="/jfinalGrid/blog/edit/${blog.id}">修改</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
	...
	<c:set var="actionUrl" value="/jfinalGrid/blog/" />
